# revec.r 
# function takes two scalar x, y components (Amag and Xmag) and computes resultant vector (magnitude, direction) in geographic coordinate system (north up, east right)
